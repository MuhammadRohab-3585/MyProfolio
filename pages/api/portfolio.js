import QuickEx from "../../public/projects/my-project/techship.png";
import TechBucks from "../../public/projects/my-project/techbucks.png";
import Digitaz from "../../public/projects/my-project/digitiz.png";
import Reglassify from "../../public/projects/my-project/Glassify.png";
const portfolio = [
  // {
  //     id: 0,
  //     projectName: "JMM ERP",
  ...
  {
    id: 0,
    projectName: "QUICK EX",
    url: "https://techship.me/",
    image: QuickEx,
    projectDetail:
      "QuickEx is a modern shipping company offering fast, reliable, and secure logistics solutions. I designed and developed their website from scratch using Next.js, ensuring a seamless user experience with optimized performance. The site highlights QuickEx's services, tracking features, and customer-centric approach.",
    technologiesUsed: [
      {
        tech: "NextJS",
      },
  ...
  {
    id: 1,
    projectName: "TechBucks",
    url: "https://thetechbucks.com/",
    image: TechBucks,
    projectDetail:
      "I developed our company website from scratch using Next.js, showcasing modern features like a background video for an immersive experience and video players for client reviews. The site includes robust state management for seamless interactions and highlights our services effectively. It’s designed to be fast, user-friendly, and visually engaging.",
    technologiesUsed: [
      {
        tech: "NextJS",
      },
  ...
  },
  {
    id: 2,
    projectName: "Digitaz",
    url: "https://networkstb.netlify.app/",
    image: Digitaz,
    projectDetail:
      "I designed a digital marketing company website using Next-js and CSS, focusing on a clean and professional layout. The site highlights key features such as services offered, career opportunities, and client success stories. It’s fully responsive and crafted to leave a lasting impression on visitors.",
    technologiesUsed: [
      {
        tech: "NextJs",
      },
  ...
  {
    id: 3,
    projectName: "Reglassify",
    url: "https://glassify.netlify.app/",
    image: Reglassify,
    projectDetail:
      "II designed and developed a website for a glass recycling company from scratch using Next.js and CSS. The site features an interactive energy calculator to estimate the energy produced through recycling processes. It offers a clean, modern UI with a focus on sustainability and user engagement.",
    technologiesUsed: [
      {
        tech: "NextJs",
      },
