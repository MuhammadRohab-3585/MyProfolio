<div align="center">
  ...
  <h2 align="center">Muhammad Rohab - Personal portfolio</h2>
...
```bash
sudo git clone https://github.com/MuhammadRohab-3585/portfolio.git
```

Windows:

```bash
git clone https://github.com/MuhammadRohab-3585/portfolio.git
```
